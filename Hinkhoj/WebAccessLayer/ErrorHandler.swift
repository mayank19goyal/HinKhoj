...
fileprivate func titleAndMessageForErrorCode(_ errorCode: Int) -> (String, String) {
    ...
    case 0:
        ...
        message = "Server not reachable".localize()
    ...
    case 500:
        title = "Server Error".localize()
        message = "Internal server error, the client should retry the request".localize()
    case 503:
        title = "Server Error".localize()
        message = "Service unavailable".localize()
    case 8001:
        title = "Network Error".localize()
        message = "Please connect to internet".localize()
    case 1560:
        title = "Error".localize()
        message = "Core data saving error".localize()
    case -1009:
        title = "Network Error".localize()
        message = "Please connect to internet and relaunch application".localize()
    case 9191:
        title = "Response Error".localize()
        message = "Invalid response received from server.".localize()
    case -1004:
        title = "Error".localize()
        message = "Could not connect to the server".localize()
    case -1001:
        title = "Error".localize()
    ...
    default:
        title = "Error".localize()
        message = "Unknown Error".localize() + " \(errorCode)"
    }
